...
# Students: ignore these two lines
# Prof TODO: Error checking on txt boxes
# Prof TODO: Color strings
...
class PointLineView(QWidget):
    ...
    def mousePressEvent(self, e):
        scale = self.getScale()
        self.pointclicked.emit(self.clicknode,
                               QPointF((e.x() - self.width() / 2.0) / scale, (self.height() / 2.0 - e.y()) / scale))
